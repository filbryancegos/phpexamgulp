<section id="our-mission">
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center slideLeft">
                <div class="col">
                    <h2>Our Mission</h2>
...
<section id="about-us">
    <div class="container">
        <div class="row d-flex align-items-center justify-content-end ">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-12-xs slideRight">
                <img class="w-100 align-right slide-in" src="public/dist/images/about.jpg" alt="">
            </div>
        </div>
    </div>
</section>
...
<section id="how-can-we-help">
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center ">
            <div class="col text-center slideDown">
